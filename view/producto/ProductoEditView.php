...
<body style="background-color: #f8f9fa;"> <!-- Añadido estilo inline para el fondo -->
    ...
    <div class="container mt-5" style="padding: 30px;">
        ...
        <form method="POST" action="../../controller/producto/ProductoController.php" style="margin-top: 20px;">
            ...
            <!-- Cantidad disponible - CORREGIDO EL NAME (antes tenía typo) -->
            <div class="mb-3" style="margin-bottom: 15px;">
            ...
            <div style="margin-top: 25px;">
                <button type="submit" class="btn btn-primary" style="padding: 10px 20px;">Actualizar</button>
                <a href="ProductoView.php" class="btn btn-secondary ms-2" style="padding: 10px 20px;">← Volver a la lista</a>
            </div>
        </form>
    </div>
