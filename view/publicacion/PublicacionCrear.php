...
<body>
    <div class="container crud-container main-content" style="padding: 40px; max-width: 600px;">
        ...
        <form id="form-registrar-publicacion"
            method="POST"
            enctype="multipart/form-data"
            action="<?= Config::get('BASE_URL')?>/controller/publicacion/PublicacionController.php"
            class="card p-4 shadow-sm border-0 rounded-4 bg-white">
