                    ...
                    <div class="col-lg-6 align-items-center justify-content-center d-flex mb-5 mb-lg-0">
                        <div class="blockabout">
                            <div class="blockabout-inner text-center text-sm-start">
                                ...
                                <!-- Descripción -->
                                <div class="mb-3">
                                    <label for="descripcion" class="form-label text-muted">Descripción <small class="text-secondary d-block">máx. 300 caracteres</small></label>
                                    <textarea class="form-control" style="width: 30vw;"  name="descripcion" id="descripcion" rows="4" maxlength="300" required><?= htmlspecialchars($perfil['descripcion']); ?></textarea>
                                </div>

                                <!-- Preferencia -->
                                <div class="mb-3">
                                    <label for="preferencia" class="form-label text-primary pt-3">Preferencia para adoptar</label>
